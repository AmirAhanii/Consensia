...
def run_pipeline():
    ...
    with open('stage4-alex.json', 'r', encoding='utf-8') as f:
        persona_data = json.load(f)
        
    with open('atrautsch_only_context.json', 'r', encoding='utf-8') as f:
...
"""
        ...
        try:
            ...
            with open('atrautsch_api_results.json', 'w', encoding='utf-8') as f:
    ...
    print("-" * 50)
    print(f"[SUCCESS] All batches completed! Final data saved to 'atrautsch_api_results.json'")
