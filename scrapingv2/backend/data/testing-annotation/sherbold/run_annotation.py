...
def run_pipeline():
    ...
    with open('stage4-steffen.json', 'r', encoding='utf-8') as f:
...
"""
        ...
        try:
            ...
            with open('sherbold_api_results.json', 'w', encoding='utf-8') as f:
    ...
    print("-" * 50)
    print(f"[SUCCESS] All batches completed! Final data saved to 'sherbold_api_results.json'")
