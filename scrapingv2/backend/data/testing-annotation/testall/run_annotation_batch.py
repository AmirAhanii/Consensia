...
# ==========================================
# CONFIGURATION: ZERO-SHOT PERSONA (SELF-CORRECTING)
# ==========================================
RESEARCHERS = [
    {
...
# ---------------------------------------------------------------------------
# SCHEMA DEFINITIONS (Updated for Self-Correction)
# ---------------------------------------------------------------------------
...
class HunkAnnotation(BaseModel):
    ...
    initial_analysis: str = Field(description="Step 1: Analyze the code objectively using standard, generic software engineering principles.")
    persona_critique: str = Field(description="Step 2: Critique your initial analysis strictly through the biases and philosophies of your assigned Persona. Explicitly state if your persona agrees or disagrees with the standard analysis.")
...
def run_pipeline():
    ...
    for researcher in RESEARCHERS:
        print(f"\n==================================================")
        print(f" 🧠 STARTING SELF-CORRECTION ANNOTATION FOR: {researcher['name']} 🧠 ")
        print(f"==================================================")
...
CRITICAL RULES - THE REFLECTION PROTOCOL:
1. initial_analysis: First, look at the code and write out what a generic software engineer would label this.
2. persona_critique: Next, aggressively critique that generic analysis using your specific persona biases. If your persona prioritizes testing over refactoring, or ignores whitespace, you MUST state that here and override the generic analysis.
3. labels: Output the final line numbers based ONLY on your persona_critique. If a category does not apply, output an empty array [].
"""
            prompt = f"Evaluate the following code hunks sequentially using the Reflection Protocol.\n{hunks_payload}"
