...
def run_pipeline():
    ...
    for researcher in RESEARCHERS:
        print(f"\n==================================================")
        print(f" 🚀 STARTING ANNOTATION FOR: {researcher['name']} 🚀 ")
        print(f"==================================================")
...
"""
            ...
            print(f"    -> Sending Hunks {i+1} to {current_end}... ", end="", flush=True)
